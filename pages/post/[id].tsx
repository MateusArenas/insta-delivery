            ...
            <div className={`col-12 d-flex flex-column position-relative h-auto order-3 ${vertical ? '' : 'col-lg-6 order-lg-2 px-lg-3'} mt-0 px-0`}>
              <div className="card-body d-flex flex-column flex-fill px-0 pt-1 border-0">
                ...
                <div className="card-footer bg-transparent border-0">
                  <small className='fw-semibold opacity-50'><span className='text-dark'><MdOutlineTimer size={20} /> <span className='align-text-top'>•</span></span> <span className='align-text-top'> 59 minutes ago</span></small>
                </div>
            </div>
            ...
            >
              <a className='col-12 col-md-6 col-lg-4 text-decoration-none hover-bump' onClick={handlePost} >
                <div className='d-flex align-items-center justify-content-center bg-secondary rounded-desktop-only w-100 h-auto position-relative overflow-hidden' style={{ aspectRatio: "16/9" }}>
                  ...
                  <Image alt='post-img' src="/images/default-post.jpg" objectFit='cover' layout="fill" width={1080} height={566}  />
                  <span className="badge bg-light position-absolute top-0 start-0 py-2 px-3 m-2">
                    <span className='text-success fw-bold'>50% off</span>
                  </span>
                  <span className="badge bg-light position-absolute bottom-0 end-0 py-1 px-3 m-2">
                    <span className='text-primary fw-bold opacity-50'><MdOutlineTimer size={20} /> <span className='align-text-bottom'>1d</span></span>
                  </span>
                </div>
              </a>
            </Link>
